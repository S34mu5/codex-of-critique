...
class PrReview(Base):
    ...
    __table_args__ = (
        Index("idx_pr_reviews_pr", "pull_request_id"),
        Index("idx_pr_reviews_author", "author_login"),
        Index("idx_pr_reviews_state", "state"),
    )
    ...
    pull_request = relationship("PullRequest", back_populates="pr_reviews")